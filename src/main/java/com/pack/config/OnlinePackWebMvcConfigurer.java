 ...
 */
@Configuration
public class OnlinePackWebMvcConfigurer extends WebMvcConfigurationSupport {
...
private OnlinePackInterceptor onlinePackInterceptor;
    ...
    public void addInterceptors(InterceptorRegistry registry) {
        ...
        registry.addInterceptor(onlinePackInterceptor).addPathPatterns("/**").excludePathPatterns("/toLogin", "/login");
