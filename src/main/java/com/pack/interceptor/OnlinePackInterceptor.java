...
/**
 * @Author: liujinhui
 * @Date: 2019/11/9 13:40
 */
@Component
public class OnlinePackInterceptor implements HandlerInterceptor {
    @Override
    public boolean preHandle(HttpServletRequest request, HttpServletResponse response, Object handler) throws Exception {
        ...
        BaseUserVO user = (BaseUserVO) request.getSession().getAttribute("user");
        if (null == user) {
